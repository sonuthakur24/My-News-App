    ...
    <footer className="bg-blue-800 text-white py-8 px-4">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        <div className="mb-4 md:mb-0 flex items-center space-x-4">
          <img src="/logo1.jpg" alt="Logo" className="h-10 w-10 rounded-full shadow-lg transform transition-transform duration-300 hover:scale-110" /> {/* Replace with your logo path */}
          <div>
